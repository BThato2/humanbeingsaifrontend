...
import MicrophoneButtonWhiteSVG from '../../assets/vectors/microphoneButtonWhite.svg'
import useAPIRouteSwitcher from 'statemanagers/apiRouteManager'

export default function AudioMicrophone() {
  ...
  //@ts-ignore
  let recorder
  var currentHost = `${apiURL}/voice-input-to-text-transcription`
  //@ts-ignore
  ...
  return (
    <div>
      ...
      >
        <Image src={MicrophoneButtonWhiteSVG} width="200px" height="200px" />
      </CustomButton>
    </div>
  )
}
