...
import InsideContentDiscoverNewAvatars from '../children/insideContentDiscoverNewAvatars'
...
export default function TheMainParentDiscoverAvatars() {
  return (
    <BlurWrapper onClick={handleParentClick}>
      ...
      >
        <CardButtonWrapper>
          ...
          <CardBase>
            <InsideContentDiscoverNewAvatars />
          </CardBase>
        </CardButtonWrapper>
      </motion.nav>
    </BlurWrapper>
