...
//@ts-ignore
import whiteExpand from '../../../../assets/vectors/whiteExpand.svg'
//@ts-ignore
import whiteX from '../../../../assets/vectors/whiteX.svg'
import InsideContentCategoriesSettings from './child/insideContentConnectionsSettings'
...
export default function TheMainParentConnectionsSettings() {
  return (
    <BlurWrapper>
      <motion.nav
      ...
      >
        <CardButtonWrapper>
          ...
          <CardBase>
            <TemporaryMarginWrapper>
              <InsideContentCategoriesSettings />
            </TemporaryMarginWrapper>
          </CardBase>
        </CardButtonWrapper>
      </motion.nav>
...
const TemporaryMarginWrapper = styled.div`
  margin-bottom: 50px;
`
